...
Motor motor1(MOTOR1_IN2, MOTOR1_IN1, MOTOR1_ENCB_PIN, MOTOR_MAX_SPEED, MOTOR_MAX_SPEED, VOLTS_PER_RAD_S, PPR, TS_S, 0.7, 1000, GEAR_RATIO);
Motor motor2(MOTOR2_IN2, MOTOR2_IN1, MOTOR2_ENCB_PIN, MOTOR_MAX_SPEED, MOTOR_MAX_SPEED, VOLTS_PER_RAD_S, PPR, TS_S, 0.7, 1000, GEAR_RATIO);
Motor motor3(MOTOR3_IN2, MOTOR3_IN1, MOTOR3_ENCB_PIN, MOTOR_MAX_SPEED, MOTOR_MAX_SPEED, VOLTS_PER_RAD_S, PPR, TS_S, 0.7, 1000, GEAR_RATIO);
Motor mot(1, 1, 1, 1, 1, 1, 1, 11, 1, 1, 1);
